...
impl GoodList {
    ...
    pub fn get_reactions_list(&self) -> Vec<i16> {
        // для скорости получения разрешенных реакций запишем их
        // в поле reactions списков и чатов. Нам надо только разбить
        // строку на звенья и превратить их в числа.
        ...
        if old_types_option.is_some() {
            ...
            let update_model = match new_types {
                1 => diesel::update(self)
                    .set(schema::good_reactions::thumbs_up.eq(self.thumbs_up + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
                2 => diesel::update(self).
                    set(schema::good_reactions::thumbs_down.eq(self.thumbs_down + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
                3 => diesel::update(self)
                    .set(schema::good_reactions::red_heart.eq(self.red_heart + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
                4 => diesel::update(self)
                    .set(schema::good_reactions::fire.eq(self.fire + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
                5 => diesel::update(self)
                    .set(schema::good_reactions::love_face.eq(self.love_face + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
                6 => diesel::update(self)
                    .set(schema::good_reactions::clapping.eq(self.clapping + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
                7 => diesel::update(self)
                    .set(schema::good_reactions::beaming.eq(self.beaming + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
                8 => diesel::update(self)
                    .set(schema::good_reactions::thinking.eq(self.thinking + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
                9 => diesel::update(self)
                    .set(schema::good_reactions::exploding.eq(self.exploding + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
                10 => diesel::update(self)
                    .set(schema::good_reactions::screaming.eq(self.screaming + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
                11 => diesel::update(self)
                    .set(schema::good_reactions::evil.eq(self.evil + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
                12 => diesel::update(self)
                    .set(schema::good_reactions::crying.eq(self.crying + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
                13 => diesel::update(self)
                    .set(schema::good_reactions::party.eq(self.party + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
                ...
                15 => diesel::update(self)
                    .set(schema::good_reactions::vomiting.eq(self.vomiting + 1))
                    .get_result::<GoodReaction>(&_connection)
                    .expect("Error."),
...
impl GoodCommentReaction {
    pub fn update_model(
        ...
        if old_types_option.is_some() {
            ...
            let update_model = match new_types {
                1 => diesel::update(self)
                    .set(schema::good_comment_reactions::thumbs_up.eq(self.thumbs_up + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                2 => diesel::update(self).
                    set(schema::good_comment_reactions::thumbs_down.eq(self.thumbs_down + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                3 => diesel::update(self)
                    .set(schema::good_comment_reactions::red_heart.eq(self.red_heart + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                4 => diesel::update(self)
                    .set(schema::good_comment_reactions::fire.eq(self.fire + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                5 => diesel::update(self)
                    .set(schema::good_comment_reactions::love_face.eq(self.love_face + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                6 => diesel::update(self)
                    .set(schema::good_comment_reactions::clapping.eq(self.clapping + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                7 => diesel::update(self)
                    .set(schema::good_comment_reactions::beaming.eq(self.beaming + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                8 => diesel::update(self)
                    .set(schema::good_comment_reactions::thinking.eq(self.thinking + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                9 => diesel::update(self)
                    .set(schema::good_comment_reactions::exploding.eq(self.exploding + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                10 => diesel::update(self)
                    .set(schema::good_comment_reactions::screaming.eq(self.screaming + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                11 => diesel::update(self)
                    .set(schema::good_comment_reactions::evil.eq(self.evil + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                12 => diesel::update(self)
                    .set(schema::good_comment_reactions::crying.eq(self.crying + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                13 => diesel::update(self)
                    .set(schema::good_comment_reactions::party.eq(self.party + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                14 => diesel::update(self)
                    .set(schema::good_comment_reactions::star_face.eq(self.star_face + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                15 => diesel::update(self)
                    .set(schema::good_comment_reactions::vomiting.eq(self.vomiting + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                16 => diesel::update(self)
                    .set(schema::good_comment_reactions::pile_of_poo.eq(self.pile_of_poo + 1))
                    .get_result::<GoodCommentReaction>(&_connection)
                    .expect("Error."),
                _ => diesel::update(self)
                    .set(schema::good_comment_reactions::pile_of_poo.eq(self.pile_of_poo + 1))
