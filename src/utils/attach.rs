...
pub fn add_doc_list(pk: i32) -> String {
    ...
    &list.id.to_string() +
    &"' style='padding: 8px;padding-bottom: 0;'><div style='display:flex'>
    <figure><a class='load_doc_list btn_default pointer'><svg fill='currentColor'
    class='svg_default border' style='width:120px;height:120px;' viewBox='0 0 24 24'>
    ...
    </svg></a></figure><div class='media-body' style='margin-left: 10px;'>
